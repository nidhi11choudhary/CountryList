...
public class CountryListViewModel extends ViewModel {
    ...
    //Livedata generates value in android
    //MutableLiveData is observable we can set a value currently have.
    //some point countries withh generate a list of countryModel
